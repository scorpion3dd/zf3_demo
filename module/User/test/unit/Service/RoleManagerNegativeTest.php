...
class RoleManagerNegativeTest extends AbstractMock
{
    ...
    /**
     * @testCase - method getRedis - Exception
     * getRedis - buildRedis - redis->connect - Exception
     *
     * @return void
     * @throws ReflectionException
     */
    public function testgetRedisException(): void
    {
        $role = $this->createRole();
        $this->setEntityId($role, self::ROLE_ID);
        $config = $this->getConfig();
        $config['redis']['connection']['default']['params']['host'] = '';
        $this->roleManager->setConfig($config);
